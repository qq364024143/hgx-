...
<body>
<inputtype="hidden" id="redirectUrl" value="${redirectUrl!''}"/>
...
<div class="cent-box">
	...
	<div class="cont-main clearfix">
		...
		<div class="login form">
			<div class="group">
				...
				<div class="group-ipt verify">
					...
					<img src="sso/getVerifyPic" class="imgcode">
				</div>
			</div>
		</div>

		<div class="button">
			<button type="submit" class="login-btn register-btn" id="login_button">登录</button>
		</div>
		...
		<div class="login form">
			<div class="group">
				<div class="group-ipt email">
					<input  name="username" id="username" class="ipt" placeholder="邮箱地址||手机号||账号" required="">
				</div>
				...
				<div class="group-ipt verify">
					<input type="text" name="verify" id="verify" class="ipt" placeholder="输入验证码" required="">
					<img src="static/imgcode.html" class="imgcode">
				</div>
			</div>
		</div>
...
<script>
	...
	$("#login_button").click(function(){
		...
		var redirectUtl = $("#redirectUtl").val();
		if(redirectUtl==''){
			redirectUtl = 'http://localhost:1003';
		}
		$.ajax({
			type:"post",
